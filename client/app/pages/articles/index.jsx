...
class Articles extends React.Component {
    ...
    filterArticles(response) {
        ...
        for (var i = 0; i < this.state.articles.length; i++) {
            ...
            if (
                this.selectedTag === 'news' &&
                this.state.articles[i].category === 'IN THE NEWS'
            ) {
                addArticleToSortList = true;
            } else if (
                this.selectedTag === 'blogs' &&
                this.state.articles[i].category === 'BLOG'
            ) {
                addArticleToSortList = true;
            } else if (
                this.selectedTag === 'videos' &&
                this.state.articles[i].category === 'VIDEO'
            ) {
                addArticleToSortList = true;
            }
            ...
            if (this.selectedTag === 'all' || addArticleToSortList) {
                if (
                    this.state.articles[i].category !== 'EVENT' &&
...
export default withRouter(connect()(Articles));
